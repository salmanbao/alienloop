...
pub fn add_genesis_accounts(genesis_config: &mut GenesisConfig, mut issued_lamports: u64) {
    ...
    // Note: we need to change for our specific address
    create_and_add_stakes(
        genesis_config,
        &StakerInfo {
            name: "initial funding",
            staker: "7WLvgoS6vXap8qW4QA2V9DWiFAobYLMP1a8rrhMeG1GT",
            lamports: (500_000_000 * LAMPORTS_PER_SOL).saturating_sub(issued_lamports),
            withdrawer: Some("7WLvgoS6vXap8qW4QA2V9DWiFAobYLMP1a8rrhMeG1GT"),
        },
        &UNLOCKS_ALL_DAY_ZERO,
        None,
    );
